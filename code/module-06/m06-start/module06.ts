...
// Проверьте, что переменная типа может принимать числа. Объявите новую переменную empIDs и присвойте ей новый объект DataStore. Вызовите функцию AddOrUpdate и присвойте ей элементы числового типа.
let empIDs = new DataStore<number>();
empIDs.AddOrUpdate(0, 50);
empIDs.AddOrUpdate(1, 65);
empIDs.AddOrUpdate(2, 89);                  
console.log(empIDs.GetData(2)); 
